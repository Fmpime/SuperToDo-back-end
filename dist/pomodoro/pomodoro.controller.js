...
let PomodoroController = class PomodoroController {
    ...
    async updateRound(dto, id) {
        return this.PomodoroService.updateRound(dto, id);
    }
    async update(dto, id, userId) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [pomodoro_dto_1.PomodoroDto, String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [pomodoro_dto_1.PomodoroDto, String, String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PomodoroController.prototype, "delete", null);
exports.PomodoroController = PomodoroController = __decorate([
    (0, common_1.Controller)('user/pomodoro'),
